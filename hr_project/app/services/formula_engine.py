...
Dəstəklənən skript dili (istifadəçiyə göstərilən qeydlərlə eynidir):
  - Dəyişənlər: `gross` (GROSS məbləği) HƏMİŞƏ mövcuddur. `sick` (bu
    ...
    istəyirsə (məs. DSMF/İTS/işsizlik xəstəlik pulunu bazaya daxil
    etməməlidirsə) sadəcə `gross - sick` yazır; istəməsə (məs. gəlir
    vergisi TAM gross üzərindən hesablanır) sadəcə istifadə etmir.
    GƏLƏCƏKDƏ bənzər istisnalar (məs. avans, kompensasiya) üçün YENİ
...
def evaluate_formula(script, variables):
    ...
    `variables`: dict, məs. {"gross": 1000.0, "sick": 340.66}. HƏMİŞƏ ən
    azı `gross` ehtiva etməlidir. GƏLƏCƏKDƏ formulalara yeni dəyişənlər
    əlavə etmək üçün çağıran tərəfdə sadəcə bu dict-ə yeni açar əlavə
